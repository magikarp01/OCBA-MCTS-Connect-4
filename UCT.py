...
class UCBState:
    def __init__(self, positions=[[0] * 6 for _ in range(7)], budget=0, initProbeBudget=0):
        ...
        self.actions = []
        self.UCBVals = [-1]*7  # budget allocation for each child node
    ...
    def update(self, action, depth, numRewardSamples):
        ...
        childState = UCBState(positions=positions, budget=0, initProbeBudget = self.initProbeBudget)
